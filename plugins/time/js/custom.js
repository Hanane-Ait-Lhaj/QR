...
$( function() {
    ...
    $('.countdown.styled').countdown({
      ...
      render: function(data) {
        $(this.el).html("<div>" + this.leadingZeros(data.days, 3) + " <span>أيام</span></div><div>" + this.leadingZeros(data.hours, 2) + " <span>ساعات</span></div><div>" + this.leadingZeros(data.min, 2) + " <span>دقائق</span></div><div>" + this.leadingZeros(data.sec, 2) + " <span>تواني</span></div>");
      }
    });
